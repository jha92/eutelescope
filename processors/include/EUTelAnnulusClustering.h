...
#ifndef EUTELANNULUSCLUSTERING_H
#define EUTELANNULUSCLUSTERING_H
...
namespace eutelescope {
  ...
  //! Annulus clustering processor for EUTelescope
  /*! This processor is devoted for clustering of a annulus shaped sensor geometries.
   *  More information to be added here.
   */

  class EUTelAnnulusClustering : public marlin::Processor,
    public marlin::EventModifier {

  public:
    //! Returns a new instance of EUTelAnnulusClustering
    /*! This method returns an new instance of the this processor.
     *  It is called by Marlin execution framework and it shouldn't be
     *  called/used by the final user.
     *
     *  @return a new EUTelAnnulusClustering.
     */
    virtual Processor *newProcessor() {
      return new EUTelAnnulusClustering;
    }

    virtual const std::string &name() const { return Processor::name(); }

    //! Default constructor
    EUTelAnnulusClustering();
  ...
  protected:
    //! Method for annulus clustering
    /*! Algorithm which actually reads in the collection of hit pixels
     ...
     *  clusters.
     */
    void annulusClustering(LCEvent *evt, LCCollectionVec *pulse);
  ...
  private:
    DISALLOW_COPY_AND_ASSIGN(EUTelAnnulusClustering)
    ...
    std::map<int, AIDA::IBaseHistogram *> _clusterSizeRHistos;
    std::map<int, AIDA::IBaseHistogram *> _clusterSizePhiHistos;
    std::map<int, AIDA::IBaseHistogram *> _hitMapXYHistos;
    std::map<int, AIDA::IBaseHistogram *> _hitMapGeomXYHistos;
  ...
  EUTelAnnulusClustering gEUTelAnnulusClustering;
}
#endif
